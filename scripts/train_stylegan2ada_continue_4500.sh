...
/opt/conda/envs/generate_image/bin/python stylegan2-ada-pytorch/train.py \
  --outdir=outputs/stylegan2ada_faces256_clean_continue_4500 \
  ...
  --aug=ada \
  --target=0.7 \
  --resume=outputs/stylegan2ada_faces256_clean_continue/00000-faces_200k_clean-mirror-paper256-kimg1000-batch64-ada-target0.7-resumecustom/network-snapshot-001000.pkl \
  --kimg=1000 \
  --snap=10 \
  --metrics=none \
  --seed=0 \
